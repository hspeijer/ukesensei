...
export function LessonDetail({ curriculum, lesson, completed, unlocked, onStartCheckpoint, onStartPractice, onBack }: LessonDetailProps) {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-5">
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            ...
            {!unlocked && (
              <span className="text-[10px] font-semibold uppercase tracking-wider text-[var(--c-text-muted)] bg-[var(--c-bg)] px-1.5 py-0.5 rounded flex items-center gap-1">
      ...
      {unlocked ? (
        ...
        <div className="bg-[var(--c-surface)]/60 rounded-xl border border-[var(--c-border-subtle)] p-5 flex items-start gap-3">
          <div className="w-9 h-9 rounded-full bg-[var(--c-bg)] flex items-center justify-center shrink-0 text-[var(--c-text-muted)]">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 1a5 5 0 00-5 5v3H6a2 2 0 00-2 2v9a2 2 0 002 2h12a2 2 0 002-2v-9a2 2 0 00-2-2h-1V6a5 5 0 00-5-5zm3 8H9V6a3 3 0 016 0v3z" />
            </svg>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-[var(--c-text-strong)]">Locked</h3>
            <p className="text-sm text-[var(--c-text-muted)] mt-0.5">
              Complete the previous lesson&apos;s checkpoint to unlock practice drills and the checkpoint for this lesson.
            </p>
          </div>
        </div>
      )}
